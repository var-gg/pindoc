...
function testTokenCounts(): void {
  ...
  assertEqual(Object.keys(visualLanguage.relations).length, 6, "Relation token count");
  ...
  assertEqual(Object.keys(visualLanguage.quick_actions).length, 6, "Quick action count");
