...
| 7 | `pindoc.artifact.translate` | reader+ |
| 8 | `pindoc.graph.neighbors` | reader+ |
| 9 | `pindoc.context.for_task` | reader+ |
| 10 | `pindoc.resource.verify` | writer |
| 11 | `pindoc.area.propose` | writer |
