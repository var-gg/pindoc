...
var bundle = Bundle{
	"en": {
		...
		"preflight.task_status_invalid":      "✗ task_meta.status %q is not one of todo | in_progress | blocked | done | cancelled",
	...
	"ko": {
		...
		"preflight.task_status_invalid":      "✗ task_meta.status %q 는 todo | in_progress | blocked | done | cancelled 중 하나여야 함",
