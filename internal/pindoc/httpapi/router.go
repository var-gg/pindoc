...
func New(cfg *config.Config, d Deps) http.Handler {
	...
	mux.HandleFunc("GET /api/p/{project}/graph-edges", d.handleGraphEdges)
	...
	mux.HandleFunc("GET /api/orgs/{org}/p/{project}/graph-edges", d.handleOrgProjectPublic(d.handleGraphEdges))
